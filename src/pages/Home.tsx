...
export function Home() {
  ...
  const filteredGames = games.filter(game => {
    ...
    const matchesCat = selectedCategory === 'All' || game.category.toLowerCase() === selectedCategory.toLowerCase();
      ...
      <div className="relative overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 text-center relative z-10 flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto font-medium">
            The ultimate online gaming destination. Play thousands of free online games instantly.
          </p>
        </div>
      </div>
